...
class Helipay {
    constructor({merchant_no, notify_url, sandbox = false} = {}, debug = false ){
        ...
        this.urls = sandbox ? {
            domesticPayScan: 'https://cbptest.helipay.com/cbtrx/rest/domestic/pay/appScan'
        } : {
            domesticPayScan: 'https://cbptrx.helipay.com/cbtrx/rest/domestic/pay/appScan'
        }
        this.debug = debug
    }
    log(...args) {
     ...
     * @param {string} type 
     */
    domesticPayScan(params){
        const pkg = {
            ...params,
            merchantNo : this.merchant_no,
        }
        return this._request(pkg,'domesticPayScan')
    }
